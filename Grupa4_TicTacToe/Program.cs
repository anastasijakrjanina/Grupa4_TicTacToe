...
Console.WriteLine($"Enter your value from 1 to 9: {players.Person1}");
...
Console.WriteLine($"Enter your value from 1 to 9: {players.Person2}");
...
{
    Console.WriteLine($"Congratulations {players.Person1}!");
...
else Console.WriteLine($"{players.Person1} YOU LOST THIS GAME!");
//Console.Clear();
